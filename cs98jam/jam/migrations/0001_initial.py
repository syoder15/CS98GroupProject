    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('companies', models.CharField(default=b'', max_length=200)),
                ('event_type', models.CharField(max_length=5)),
                ('event_date', models.DateField()),
                ('start_time', models.TimeField()),
                ('end_time', models.TimeField()),
                ('creator', models.ForeignKey(related_name=b'owned_events', blank=True, to=settings.AUTH_USER_MODEL)),
                ('users', models.ManyToManyField(related_name=b'events', to=settings.AUTH_USER_MODEL, blank=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('events', models.ManyToManyField(to='jam.Event', blank=True)),
                ('owned_events', models.ManyToManyField(related_name=b'owned_events', to='jam.Event', blank=True)),
        ...
        migrations.AddField(
            model_name='company',
            name='events',
            field=models.ManyToManyField(related_name=b'company_events', to='jam.Event', blank=True),
        ...
        migrations.AddField(
            model_name='channel',
            name='events',
            field=models.ManyToManyField(to='jam.Event', blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='channel',
