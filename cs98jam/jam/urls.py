...
urlpatterns = patterns('', 
    ...
    #url(r'^company/edit/(?P<comp_name>.+)/$', views.edit_company_page, name='edit_company_page'),
    url(r'edit/company/(?P<comp_name>.+)/$', views.edit_company_page, name='edit_company_page'),
